...
const socialLinks = [
  { label: 'Instagram', url: config.instagram, icon: <FaInstagram size={24} /> },
  { label: 'LinkedIn', url: config.linkedin, icon: <FaLinkedin size={24} /> },
  { label: 'GitHub', url: `https://github.com/${config.github}`, icon: <FaGithub size={24} /> },
];
  ...
  return (
    <header className={styles.navbar} ref={headerRef}>
      ...
      >
        ...
        <img src={logo} width={48} height={48} alt='Logo Mauricio Pucheta' />
