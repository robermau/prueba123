...
export function Error({ error }) {
  ...
  const getMessage = () => {
    switch (error.status) {
      case 404:
        return {
          summary: 'Error: Redacción',
          message:
            'No se pudo encontrar esta página. No existe o fue eliminada. O quizás no existes y esta página web no pudo encontrarte.',
        };
      case 405:
        return {
          summary: 'Error: Método denegada',
          message: error.data,
        };
      default:
        return {
            ...
            <div className={styles.videoContainer} data-visible={visible}>
              ...
              {flatlined ? (
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                >
                  Animación de Ghost in the Shell (1995)
                </a>
              )}
            </div>
          </>
